...
public class SecurityConfiguration {
    ...
    public SecurityConfiguration(UserNamePasswordAuthenticationProvider userNamePasswordAuthenticationProvider) { this.userNamePasswordAuthenticationProvider = userNamePasswordAuthenticationProvider; }

    @Autowired
    public void securityProviderBuilderConfig(AuthenticationManagerBuilder authenticationManagerBuilder) {
